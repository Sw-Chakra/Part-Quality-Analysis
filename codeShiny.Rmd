...
shinyServer <-(function(input, output) {
  ...
  output$choose_feature_cate <- renderUI({
    selectInput("feature_category", "Feature Category", as.list(feature_cate))
  })
